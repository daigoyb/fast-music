...
import { instrumentType } from './Class/instrument.schema';

const schemas: SchemaTypeDefinition[] = [homeType, siteSettingsType, carouselType, carouselItemType, professorType, instrumentType];
